...
const SECTIONS = [
  ...
  {
    id: "cause_1",
    label: "Cause 1 — Equal Rights",
    fields: ["heading", "body"],
    hasImage: true,
  },
  {
    id: "cause_2",
    label: "Cause 2 — Child Protection",
    fields: ["heading", "body"],
    hasImage: true,
  },
  {
    id: "cause_3",
    label: "Cause 3 — Planet",
    fields: ["heading", "body"],
    hasImage: true,
  },
  {
    id: "about",
    label: "About / Documentary",
    fields: ["heading", "body"],
    hasImage: true,
  },
...
export default function AdminPanel() {
  ...
  const saveContent = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API}/api/admin/content/${section}`, data, {
            ...
            <div>
              ...
              <div className="admin-section-list">
                {SECTIONS.map((s) => (
                  <button
                    key={s.id}
                    className={`admin-section-btn ${section === s.id ? "active" : ""}`}
                ...
                {currentSection?.fields.includes("subheading") && (
                  <div className="admin-field">
                    ...
                    <input
                      ...
                      placeholder="Subheading or attribution"
                    />
                  </div>
                )}
          ...
          <div>
            <div className="admin-codes-header">
              <div className="admin-codes-header-text">
                <span className="admin-codes-header-tag">
                  Generate New Codes
                </span>
                <div className="admin-codes-count-wrap">
                  <input
                    className="admin-codes-count-input"
                    type="number"
                    min={1}
                    max={100}
                    value={codeCount}
                  ...
                  />
                  <span className="admin-codes-count-label">
                    codes to generate
                  </span>
                </div>
              </div>
                ...
                <tbody>
                  ...
                  {codes.map((code) => (
                    <tr key={code._id}>
                      ...
                      <td>
                        <span
                          className={`admin-badge admin-badge--${code.used ? "used" : "available"}`}
                        >
